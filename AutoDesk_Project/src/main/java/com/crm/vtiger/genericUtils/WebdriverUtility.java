...
public class WebdriverUtility {
	...
	/**
	 * This method will clear text field before entering the data
	 * @param target
	 * @param text
	 */
	...
	/**
	 * this method will maximize the window to full screen
	 * 
	 * @param driver
	 */
	...
	/**
	 * This method will wait until the visibility of the web element
	 * 
	 * @param driver
	 * @param element
	 */
